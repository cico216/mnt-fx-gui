 ...
 * </p>
 * @author    mnt.cico
 * @version  2016年5月19日 下午8:09:08 mnt.cico .
 * @since   FX8.0
 */
public abstract class Base3DLauncher extends Application {
	//使用默认的窗口
	...
	public void start(Stage stage) throws Exception {
		...
		Base3DController baseController = getRoot();
		...
		//设置摄像机
		stage.getScene().setCamera(baseController.getCamera());
		//添加关闭请求 直接退出
	...
	public abstract Base3DController getRoot(); 
